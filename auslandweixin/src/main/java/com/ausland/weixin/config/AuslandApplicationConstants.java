...
public class AuslandApplicationConstants {
	...
	public static final String ZHONGHUAN_COURIER_SEARCH_PROMPT="请输入手机号查询最近三个月的单号信息，或者输入重庆中环的单号查询具体物流信息,或者输入商品编号查询库存信息";
	public static final String REFINED_SEARCH_PROMPT="找到与您输入最接近的商品编号如下:\n";
	public static final String NO_MATCH_PROMPT="没有找到您输入的商品编号的相关库存信息";
